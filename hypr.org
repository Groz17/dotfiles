...
#+begin_src hyprlang
bind = , f21, exec, echo '{ "command": ["get_property", "af"] }' | socat - /tmp/mpvsocket | jq -er '.data[]?' || { echo '{ "command": ["set_property", "af","lowpass=f=400"] }' | socat - /tmp/mpvsocket ; false ;}  && echo '{ "command": ["set_property", "af",""] }' | socat - /tmp/mpvsocket 
#+end_src
