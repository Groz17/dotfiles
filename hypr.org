...
# bind= , f24, exec, echo '{ "command": ["set_property", "loop-file", "inf"] }' | socat - /tmp/mpvsocket
bind= , f24, exec,echo '{"command":["set_property","loop-file","'"$(echo '{"command":["get_property","loop-file"]}' | socat - /tmp/mpvsocket | grep -q inf && echo no || echo inf)"'"]}' | socat - /tmp/mpvsocket
#+end_src
**** Audio effects
#+begin_src hyprlang
