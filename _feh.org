* KEY BINDINGS
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/feh/keys")
:END:
...
* MOUSE BINDINGS
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/feh/button")
:END:
...
* THEMES
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/feh/themes")
:END:
