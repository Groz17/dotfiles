...
* Prefs
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/REAPER/Scripts/reaper-keys/internal/definitions/config.lua")
:END:
...
* Keybindings
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/REAPER/Scripts/reaper-keys/internal/definitions/bindings.lua")
:END:
