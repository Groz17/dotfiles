...
* Gitconfig
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/git/config")
:END:
...
* Commit template
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/git/message")
:END:

# :header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/git/COMMIT_TEMPLATE")
...
* Gitignore
:PROPERTIES:
:header-args: :tangle (concat (getenv "XDG_CONFIG_HOME") "/git/ignore")
:END:
